...
create index if not exists idx_block_clicks_page_time on public.block_clicks(page_id, created_at desc);
create index if not exists idx_page_events_page_time  on public.page_events(page_id, created_at desc);
