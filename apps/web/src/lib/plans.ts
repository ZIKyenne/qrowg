...
export const PLANS: Record<PlanId, Plan> = {
  ...
  starter: {
    ...
    features: ["5 pages", "850 vues/mois", "7 QR codes personnalisés", "Sans branding", "Domaine personnalisé", "10 templates premium", "QR Studio (limité)", "QR Print Studio (limité)"],
    perks: [
