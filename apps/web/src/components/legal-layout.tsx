    ...
    <div style={{ background:"var(--bg)", minHeight:"100vh", fontFamily:"DM Sans, sans-serif" }}>
      <style>{`
        * { box-sizing:border-box; }
        ...
        .ls h2 { font-family:"Fraunces,serif"; font-size:22px; font-weight:700; color:var(--ink); margin-bottom:16px; padding-bottom:12px; border-bottom:1px solid rgba(201,168,76,0.15); }
        ...
        .ls a  { color:var(--accent); text-decoration:none; border-bottom:1px solid rgba(201,168,76,0.3); }
        .ls a:hover { border-color:var(--accent); }
        .ls strong { color:rgba(245,240,232,0.8); font-weight:600; }
        .lph { display:inline-block; background:rgba(201,168,76,0.1); border:1px dashed rgba(201,168,76,0.4); border-radius:4px; padding:2px 8px; color:var(--accent); font-size:12px; font-style:italic; }
