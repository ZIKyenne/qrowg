...
// ?vide=1 : aucun domaine connecté — l'état par défaut de tout compte.
export default async function E2EDomainesPage({ searchParams }: { searchParams?: Promise<{ vide?: string }> }) {
  ...
  return <ToastProvider><ConfirmProvider><DomainsPage pages={pages} plan="business" initialDomains={vide ? [] : domains} /></ConfirmProvider></ToastProvider>
}
