...
import { themeBackgroundStyle, avatarShapeStyle, isClipShape } from "../dashboard/builder/types"
  ...
  switch (block.type) {
    case "profile": return (
      <div style={{ textAlign: "center", padding: "32px 20px 20px" }}>
        {c.avatar
          ? <img src={c.avatar} alt="" style={{ width: 96, height: 96, ...avatarShapeStyle(c.avatar_shape), objectFit: "cover", margin: "0 auto 14px", display: "block", border: isClipShape(c.avatar_shape) ? "none" : `3px solid ${G}50`, boxShadow: isClipShape(c.avatar_shape) ? "none" : `0 0 30px ${G}25`, filter: isClipShape(c.avatar_shape) ? `drop-shadow(0 0 9px ${G}66)` : undefined }} />
