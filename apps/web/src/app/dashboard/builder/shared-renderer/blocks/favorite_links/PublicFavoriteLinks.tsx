  ...
  return (
    <div style={{ padding: "10px 24px 14px" }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
        {/* Lot v174 : le filtre est parti dans le modèle — c'est lui qui décide
            si un lien favori existe, et l'éditeur pose la même question. Filtrer
            ici rendait le `visible` du modèle faux. */}
        {items.map((it, i) => (
