    ...
    <div style={{ padding: edgeCss(c.edge, u.scale) }}>
      <div style={{
        ...
        <div style={{ position: "relative", padding: `${Math.round(20 * u.scale)}px ${Math.round(18 * u.scale)}px`, textAlign: align }}>
          ...
          {c.title && <h2 style={{ color: "#FFFFFF", fontSize: Math.round(23 * u.scale), fontWeight: 800, margin: 0, lineHeight: 1.2, fontFamily: u.FONT_D, textShadow: "0 2px 12px rgba(0,0,0,0.5)" }}>{c.title}</h2>}
