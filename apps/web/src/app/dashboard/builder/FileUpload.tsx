...
export default function FileUpload({ value, onChange, hint }: Props) {
  ...
  return (
    <div>
      {value ? (
        <div style={{ display: "flex", alignItems: "center", gap: 9, background: "rgba(255,255,255,0.03)", border: "1px solid color-mix(in srgb, var(--accent) 25%, transparent)", borderRadius: 9, padding: "9px 11px" }}>
      ...
      {libOpen && (
        <div onClick={() => setLibOpen(false)}
          ...
          <div onClick={e => e.stopPropagation()}
            style={{ width: "100%", maxWidth: 520, maxHeight: "80vh", background: "#141414", border: "1px solid color-mix(in srgb, var(--accent) 20%, transparent)", borderRadius: 14, overflow: "hidden", display: "flex", flexDirection: "column" }}>
            ...
            <div style={{ padding: 12, overflowY: "auto", display: "flex", flexDirection: "column", gap: 6 }}>
              ...
              {libAssets === null
                ...
                : libAssets.map(a => (
                    <div key={a.url} style={{ display: "flex", alignItems: "center", gap: 9, background: value === a.url ? "color-mix(in srgb, var(--accent) 8%, transparent)" : "rgba(255,255,255,0.02)", border: `1px solid ${value === a.url ? "color-mix(in srgb, var(--accent) 40%, transparent)" : "rgba(255,255,255,0.07)"}`, borderRadius: 9, padding: "8px 11px" }}>
