...
export const BLOCK_DEFS: Record<string, BlockDef> = {
  ...
  offer_comparison: {
    ...
    fields: [
      ...
      { key: "plan1_features", label: "Formule 1 — Avantages (1 par ligne)", type: "textarea", placeholder: "1 projet / Support email
5 GB stockage" },
      ...
      { key: "plan2_features", label: "Formule 2 — Avantages", type: "textarea", placeholder: "10 projets / Support prioritaire
50 GB stockage" },
      ...
      { key: "plan3_features", label: "Formule 3 — Avantages", type: "textarea", placeholder: "Illimité / Account manager
API access" },
  ...
  packs: {
    ...
    fields: [
      ...
      { key: "pack1_content", label: "Pack 1 — Contenu", type: "textarea", placeholder: "Audit complet / Rapport PDF
1 heure conseil" },
      ...
      { key: "pack2_content", label: "Pack 2 — Contenu", type: "textarea", placeholder: "Tout le Starter / + Formation
+ Suivi 3 mois" },
