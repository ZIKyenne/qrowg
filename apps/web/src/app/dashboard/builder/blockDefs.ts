...
export const BLOCK_DEFS: Record<string, BlockDef> = {
  ...
  cta_button: {
    ...
    fields: [
      ...
      { key: "full_width", label: "Pleine largeur", type: "select", options: ["yes", "no"], role: "miseEnPage" },
    ],
  },
  calendly: {
  ...
  menu_tabs: {
    ...
    fields: [
      ...
      { key: "text_size", label: "Taille du texte", type: "select", options: ["Compact", "Normal", "Grand"], role: "apparence" },
      { key: "row_density", label: "Densité", type: "select", options: ["Serré", "Normal", "Aéré"] },
      { key: "item_columns", label: "Colonnes", type: "select", options: ["1 colonne", "2 colonnes"], role: "miseEnPage" },
  ...
  image: {
    ...
    fields: [
      ...
      { key: "rounded", label: "Coins", type: "select", options: ["rounded", "square", "circle"], role: "apparence" },
  ...
  gallery: {
    ...
    fields: [
      ...
      { key: "columns_mobile", label: "Colonnes (mobile)", type: "select", options: ["1", "2", "3"], role: "miseEnPage" },
  ...
  cover_banner: {
    ...
    fields: [
      ...
      { key: "grad_preset", label: "Dégradé", type: "select", options: ["or_nuit", "aurore", "ocean", "coucher", "violet", "menthe", "corail", "personnalise"], showIf: { key: "banner_type", equals: "gradient" }, role: "apparence" },
  ...
  free_section: {
    ...
    fields: [
      ...
      { key: "min_height", label: "Hauteur minimale (px)", type: "text", placeholder: "0", hint: "0 = la hauteur s'adapte au contenu.", role: "miseEnPage" },
      ...LAYOUT_STYLE_FIELDS,
    ],
  },
  ...
  image_text: {
    ...
    fields: [
      ...
      { key: "image_width", label: "Largeur de l'image", type: "select", options: ["Petite", "Moyenne", "Grande"], role: "miseEnPage" },
  ...
  overlay_card: {
    ...
    fields: [
      ...
      { key: "edge", label: "Largeur", type: "select", options: ["Marges", "Bord à bord"], role: "miseEnPage" },
    ],
  },
  ...
  full_bleed_image: {
    ...
    fields: [
      ...
      { key: "radius", label: "Coins", type: "select", options: ["Aucun", "Doux", "Arrondi", "Très arrondi"] },
      { key: "edge", label: "Largeur", type: "select", options: ["Bord à bord", "Marges"], role: "miseEnPage" },
    ],
  },
  ...
  logo_marquee: {
    ...
    fields: [
      ...
      { key: "logo_height", label: "Hauteur des logos (px)", type: "text", placeholder: "40", role: "miseEnPage" },
  ...
  decor_line: {
    ...
    fields: [
      ...
      { key: "space", label: "Espace autour (px)", type: "text", placeholder: "14", role: "miseEnPage" },
    ],
  },
  ...
  color_band: {
    ...
    fields: [
      ...
      { key: "angle", label: "Angle du dégradé", type: "text", placeholder: "135", showIf: { key: "fill", equals: "Dégradé" }, role: "apparence" },
  ...
  big_statement: {
    ...
    fields: [
      ...
      { key: "color", label: "Couleur", type: "color" },
      { key: "color2", label: "Seconde couleur", type: "color", showIf: { key: "fill", equals: "Dégradé" } },
      { key: "spacing", label: "Espacement des lettres", type: "select", options: ["Serré", "Normal", "Large"], role: "apparence" },
  ...
  text_columns: {
    ...
    fields: [
      ...
      { key: "rule", label: "Trait entre les colonnes", type: "select", options: ["Non", "Oui"], role: "apparence" },
  ...
  steps_horizontal: {
    ...
    fields: [
      ...
      { key: "marker_size", label: "Taille des repères (px)", type: "text", placeholder: "34", role: "miseEnPage" },
      { key: "accent_color", label: "Couleur", type: "color" },
      ...LAYOUT_STYLE_FIELDS,
    ],
  },
  ...
  icon_row: {
    ...
    fields: [
      ...
      { key: "i5_image", label: "Icône 5 — Image", type: "image" },
      { key: "i5_label", label: "Icône 5 — Texte", type: "text", placeholder: "" },
      { key: "i6_emoji", label: "Icône 6 — Emoji", type: "text", placeholder: "" },
      { key: "i6_image", label: "Icône 6 — Image", type: "image" },
      { key: "i6_label", label: "Icône 6 — Texte", type: "text", placeholder: "" },
      { key: "icon_style", label: "Style", type: "select", options: ["Cercle", "Nu"], role: "apparence" },
      { key: "icon_size", label: "Taille (px)", type: "text", placeholder: "44", role: "miseEnPage" },
      { key: "per_row", label: "Par ligne", type: "select", options: ["2", "3", "4", "5", "6"], role: "miseEnPage" },
      { key: "color", label: "Couleur", type: "color" },
      ...LAYOUT_STYLE_FIELDS,
    ],
  },
  ...
  highlight_box: {
    ...
    fields: [
      ...
      { key: "background", label: "Fond", type: "select", options: ["Teinté", "Aucun"], role: "apparence" },
      { key: "align", label: "Alignement", type: "select", options: ["Gauche", "Centre"] },
      ...LAYOUT_STYLE_FIELDS,
    ],
  },
